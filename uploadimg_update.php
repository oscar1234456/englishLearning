...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    if($_FILES['file']['error']>0){
        ...
        <script type="text/javascript"> setTimeout("window.location.href='uploadimg_update.php'",3000)</script>
        <?php
    }else{
    ...
    <?php }else{
        ...
        <form action="deleteimg_update.php" method="post" name="form_cancel">
