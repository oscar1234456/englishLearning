...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark" style="background-color:#355772;" ><a class="navbar-brand" href="eng_learning_login.php"> <img class="d-inline-block align-top" src="images/phy_icon.png" width="30" height="30" alt="">   &nbsp;&nbsp;   *英語背誦王*</a>
            ...
            <div class="col-md-4 offset-md-4">
                <div class="card mx-auto mt-5">
                    <div class="card-header">
                        <h3 align="center">學校授權軟體登入系統</h3>
                        <h5 align="center">Software Login System</h5>
                    </div>
                    <div class="card-body">
